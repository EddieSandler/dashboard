...
| Goal       | What goal will your project be designed to achieve?                                                                                                                                                                                                                                                                                                      |  This will be a dashboard that will provide a user with a snapshot of the current state of the US Markets and the Economy along with current Headline News.        |
| Users      | What kind of users will visit your app? In other words, what is the demographic of your users?                                                                                                                                                                                                                                                           |  Ideally students at the High school or college level studying Finance and Economics.        |

| Data       | What data do you plan on using? How are you planning on collecting your data? You may have not picked your actual API yet, which is fine, just outline what kind of data you would like it to contain. You are welcome to create your own API and populate it with data. If you are using a Python/Flask stack, you are required to create your own API. |  The required data will be provided by yahoo finance and The St Louis Federal Reserve (FRED) APIS.       |
